...
test('startet ETS2 über Steam mit der vollständigen aktuellen SCS-Session-ID',()=>{
  const args=steamLaunchArguments({steamAppId:'227300'},{searchId:'85568392925767505/101'});
  assert.deepEqual(args,['-silent','-applaunch','227300','+connect_lobby','85568392925767505/101']);
